...
friendsRouter.get('/sentrequests', friendsController.getFriendRequests)
...
friendsRouter.post('/requestfriend', passport.authenticate('jwt', { session: false }), friendsController.sendRequest)

//if friend request is accepted, add friend. try this with jwt tokens
friendsRouter.post('/addfriend', passport.authenticate('jwt', { session: false }), friendsController.addContact)
